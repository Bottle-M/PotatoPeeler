...
public class Potato {
     ...
     */
    public static PeelResult peel(String worldPath, long minInhabited, long mcaModifiableDelay, int threadsNum) throws RegionFileNotFoundException, RegionTaskInterruptedException, RegionTaskNotAcceptedException, RegionTaskAlreadyStartedException {
        // 先检查世界目录下的区域文件目录是否存在
        ...
        // 找到 .mca 文件了则开始处理
        // 创建任务调度器
        RegionTaskDispatcher dispatcher = new RegionTaskDispatcher(minInhabited, mcaModifiableDelay, threadsNum);
        // 把文件提交给任务调度器
